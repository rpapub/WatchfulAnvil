...
namespace {{NAMESPACE}}.Rules.Sample
{
    public class SampleRule : IRegisterAnalyzerConfiguration
    {
        private const string RuleId = "{{PREFIX}}-SAMPLE-001";
        ...
        public Rule<IActivityModel> Get()
        {
            return new Rule<IActivityModel>("Sample rule title", RuleId, InspectActivity)
            {
                ...
                DocumentationLink = "https://github.com/rpapub/WatchfulAnvil/wiki/Rule-Documentation-{{PREFIX}}-SAMPLE-001"
            };
        }
