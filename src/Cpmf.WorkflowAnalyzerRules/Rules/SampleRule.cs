...
namespace Cpmf.Rules.Sample
{
    public class SampleRule : IRegisterAnalyzerConfiguration
    {
        private const string RuleId = "CPMF-SAMPLE-001";
        ...
        public Rule<IActivityModel> Get()
        {
            return new Rule<IActivityModel>("Sample rule title", RuleId, InspectActivity)
            {
                ...
                DocumentationLink = "https://github.com/rpapub/WatchfulAnvil/wiki/Rule-Documentation-CPMF-SAMPLE-001"
            };
        }
